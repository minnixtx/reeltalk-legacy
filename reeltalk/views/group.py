...
from reeltalk.models import NotificationType
from reeltalk.suggested_users import suggested_users
from reeltalk.views.helpers import get_user_from_username, maybe_redirect_local_path
...
class Group(View):
    ...
    def post(self, request, group_id):
        ...
        model = apps.get_model("reeltalk.Notification", require_ready=True)

...
from reeltalk.models.report import USER_SUSPENSION, USER_UNSUSPENSION, USER_DELETION
from reeltalk.views.helpers import redirect_to_referer, is_api_request
from reeltalk.settings import PAGE_LENGTH


@method_decorator(login_required, name="dispatch")
@method_decorator(
    permission_required("reeltalk.moderate_user", raise_exception=True),
    name="dispatch",
)
@method_decorator(
    permission_required("reeltalk.moderate_post", raise_exception=True),
    name="dispatch",
)
...
@login_required
@permission_required("reeltalk.moderate_user")
...
@login_required
@permission_required("reeltalk.moderate_post")

...
from reeltalk.connectors import create_finna_connector, create_libris_connector
from reeltalk.connectors.settings import CONNECTORS
from reeltalk.models import Connector


@method_decorator(login_required, name="dispatch")
@method_decorator(
    permission_required("reeltalk.edit_instance_settings", raise_exception=True),
    name="dispatch",
)
class ConnectorSettings(View):
    ...
    def get(self, request):
        ...
        other_connectors = (
            Connector.objects.exclude(connector_file="reeltalk_connector")
            .order_by("name")
            .difference(update_connectors)
        )

        # other ReelTalk instances
        ...
        data = {
            ...
            "reeltalk_connectors": bookwrym_connectors,

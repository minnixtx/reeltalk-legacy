...
def is_reeltalk_request(request):
    """check if the request is coming from another reeltalk instance"""
    user_agent = request.headers.get("User-Agent")
    if user_agent is None or re.search(regex.REELTALK_USER_AGENT, user_agent) is None:
        return False
    return True

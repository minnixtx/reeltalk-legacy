...
from reeltalk.decorators import require_federation
from reeltalk.settings import BASE_URL, DOMAIN, VERSION, LANGUAGE_CODE
...
def nodeinfo(_):
    ...
    return JsonResponse(
        {
            "version": "2.0",
            "software": {"name": "reeltalk", "version": VERSION},

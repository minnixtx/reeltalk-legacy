...
from reeltalk.tasks import app, IMPORT_TRIGGERED, IMPORTS
...
class ImportItem(models.Model):
    ...
    def review_published(self):
        """date the review was published - included in ReelTalk export csv"""
    ...
    if job.include_reviews and (item.rating or item.review) and not item.linked_review:
        ...
        if item.review:
            ...
            if not review:
                ...
                review.save(software="reeltalk", priority=IMPORT_TRIGGERED)
        else:
            # just a rating
        ...
        # only broadcast this review to other reeltalk instances

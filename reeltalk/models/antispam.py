...
class AdminModel(ReelTalkModel):
    ...
    def raise_not_editable(self, viewer):
        if viewer.has_perm("reeltalk.moderate_user"):
            return
...
def automod_task():
    ...
    admins = User.admins()
    notification_model = apps.get_model("reeltalk", "Notification", require_ready=True)
...
def automod_users(reporter):
    ...
    report_model = apps.get_model("reeltalk", "Report", require_ready=True)

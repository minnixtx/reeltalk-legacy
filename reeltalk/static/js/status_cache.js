...
let StatusCache = new (class {
    ...
    cycleShelveButtons(button, identifier) {
        ...
        button
            ...
            .forEach((item) => ReelTalk.classHide(item));
        ...
        ReelTalk.classHide(mainButton);

        // Just hide the other two menu options, idk what to do with them
        button.querySelectorAll("[data-extra-options]").forEach((item) => ReelTalk.classHide(item));

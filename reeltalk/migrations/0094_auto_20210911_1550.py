...
def set_deactivate_date(apps, schema_editor):
    ...
    apps.get_model("reeltalk", "User").objects.using(db_alias).filter(
        is_active=False
...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ("reeltalk", "0093_alter_sitesettings_instance_short_description"),
    ]
    ...
    operations = [
        ...
        migrations.AlterField(
            ...
            field=models.ManyToManyField(
                blank=True, related_name="saved_lists", to="reeltalk.List"
            ),
        ),

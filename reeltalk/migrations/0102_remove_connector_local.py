...
def remove_self_connector(app_registry, schema_editor):
    ...
    app_registry.get_model("reeltalk", "Connector").objects.using(db_alias).filter(
...
def reverse(app_registry, schema_editor):
    ...
    db_alias = schema_editor.connection.alias
    model = app_registry.get_model("reeltalk", "Connector")
...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ("reeltalk", "0101_auto_20210929_1847"),
    ]

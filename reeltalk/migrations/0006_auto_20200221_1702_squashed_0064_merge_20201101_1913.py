...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ("reeltalk", "0005_auto_20200221_1645"),
    ]
    ...
    operations = [
        ...
        migrations.AddField(
            ...
            field=models.ManyToManyField(
                ...
                through="reeltalk.UserFollowRequest",
                to=settings.AUTH_USER_MODEL,
            ),
        ),
        migrations.AddField(
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "book",
                    models.ForeignKey(
                        on_delete=django.db.models.deletion.PROTECT, to="reeltalk.Book"
                    ),
                ),
            ],
            options={
        ...
        migrations.AddConstraint(
            ...
            constraint=models.CheckConstraint(
                condition=models.Q(
                    # ConnectorFiles values inlined: the connector models were
                    # removed from this fork, but the historical constraint
                    # must stay byte-identical for fresh databases.
                    connector_file__in=[
                        "openlibrary",
                        "inventaire",
                        "reeltalk_connector",
        ...
        migrations.AddField(
            ...
            name="shelves",
            field=models.ManyToManyField(
                through="reeltalk.ShelfBook", to="reeltalk.Shelf"
            ),
        ),
        migrations.AlterField(
            model_name="comment",
        ...
        migrations.AlterField(
            ...
            name="books",
            field=models.ManyToManyField(
                through="reeltalk.ShelfBook", to="reeltalk.Edition"
            ),
        ),
        migrations.AlterField(
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "code",
                    models.CharField(
                        default=reeltalk.models.site.new_access_code, max_length=32
                    ),
                ),
            ...
            fields=[
                ...
                (
                    ...
                    models.DateTimeField(
                        default=reeltalk.models.site.get_password_reset_expiry
                    ),
                ),
                (
                    "user",

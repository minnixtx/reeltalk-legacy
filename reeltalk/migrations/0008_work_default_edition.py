...
def set_default_edition(app_registry, schema_editor):
    ...
    works = app_registry.get_model("reeltalk", "Work").objects.using(db_alias)
    editions = app_registry.get_model("reeltalk", "Edition").objects.using(db_alias)
    for work in works:
...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ("reeltalk", "0007_auto_20201103_0014"),
    ]

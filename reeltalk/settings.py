"""reeltalk settings and configuration"""
...
MIDDLEWARE = [
    ...
    "reeltalk.middleware.RequireSignedGet",
    "reeltalk.middleware.RequireLoginNearlyEverywhere",
    "reeltalk.middleware.TimezoneMiddleware",
    "reeltalk.middleware.IPBlocklistMiddleware",
    "django.contrib.messages.middleware.MessageMiddleware",
    "django.middleware.clickjacking.XFrameOptionsMiddleware",
    "reeltalk.middleware.FileTooBig",
    "reeltalk.middleware.ForceLogoutMiddleware",
]
...
TEMPLATES = [
    {
        ...
        "OPTIONS": {
            "context_processors": [
                ...
                "reeltalk.context_processors.site_settings",
            ],
...
LOGGING = {
    ...
    "filters": {
        ...
        "ignore_missing_variable": {
            "()": "reeltalk.utils.log.IgnoreVariableDoesNotExist",
        },
    },
    "handlers": {
    ...
    "loggers": {
        ...
        # Add a reeltalk-specific logger
        "reeltalk": {
            "handlers": ["console"],
            "level": LOG_LEVEL,
        },
...
# when debug is disabled, make sure to compile themes once with `./rt-dev compile_themes`
...
DATABASES = {
    "default": {
        ...
        "NAME": env("POSTGRES_DB", "reeltalk"),
        "USER": env("POSTGRES_USER", "reeltalk"),
        "PASSWORD": env("POSTGRES_PASSWORD", "reeltalk"),
...
IMAGEKIT_DEFAULT_CACHEFILE_STRATEGY = "reeltalk.thumbnail_generation.Strategy"
...
INSTANCE_ACTOR_USERNAME = "reeltalk.instance.actor"

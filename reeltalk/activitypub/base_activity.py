...
TReelTalkModel = TypeVar("TReelTalkModel", bound=base_model.ReelTalkModel)
...
class ActivityObject:
    ...
    def __init__(
        ...
        activity_objects: Optional[
            dict[str, Union[str, list[str], ActivityObject, base_model.ReelTalkModel]]
        ] = None,
        **kwargs: Any,
    ):
    ...
    def to_model(
        self,
        model: Optional[type[TReelTalkModel]] = None,
        instance: Optional[TReelTalkModel] = None,
        allow_create: bool = True,
        save: bool = True,
        overwrite: bool = True,
        allow_external_connections: bool = True,
        trigger=None,
    ) -> Optional[TReelTalkModel]:
...
def set_related_field(
    ...
    model = apps.get_model(f"reeltalk.{model_name}", require_ready=True)
    origin_model = apps.get_model(f"reeltalk.{origin_model_name}", require_ready=True)
...
def resolve_remote_id(
    ...
    get_activity: bool = False,
    allow_external_connections: bool = True,
) -> base_model.ReelTalkModel: ...


def resolve_remote_id(
    remote_id: str,
    model: Optional[Union[str, type[base_model.ReelTalkModel]]] = None,
    refresh: bool = False,
    save: bool = True,
    get_activity: bool = False,
    allow_external_connections: bool = True,
    ...
    if model:  # a bonus check we can do if we already know the model
        if isinstance(model, str):
            model = apps.get_model(f"reeltalk.{model}", require_ready=True)

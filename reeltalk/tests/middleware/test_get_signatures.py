...
from reeltalk.activitypub.base_activity import get_representative
from reeltalk.settings import DOMAIN
from reeltalk.signatures import make_signature, create_key_pair


class TestReelTalkGetSignatures(TestCase):
    ...
    def setUpTestData(cls):
        ...
        cls.sender.remote_id = "https://example.com/user/reeltalk.instance.actor"
        key_pair = cls.sender.key_pair
        key_pair.remote_id = (
            "https://example.com/user/reeltalk.instance.actor/#main-key"
        )

...
class TwoFactorViews(TestCase):
    ...
    def test_post_edit_2fa(self, *_):
        ...
        with patch("reeltalk.views.preferences.security.Edit2FA"):
            result = view(request)
        self.assertIsInstance(result, TemplateResponse)
        self.assertEqual(result.status_code, 200)
    ...
    def test_post_confirm_2fa(self, *_):
        ...
        with patch("reeltalk.views.preferences.security.Confirm2FA"):
            result = view(request)
        self.assertIsInstance(result, TemplateResponse)
        self.assertEqual(result.status_code, 200)
    ...
    def test_post_disable_2fa(self, *_):
        ...
        with patch("reeltalk.views.preferences.security.Disable2FA"):
            result = view(request)
        self.assertIsInstance(result, TemplateResponse)
        self.assertEqual(result.status_code, 200)
    ...
    def test_post_login_with_2fa(self, *_):
        ...
        with (
            patch("reeltalk.views.preferences.security.LoginWith2FA"),
            patch("reeltalk.views.preferences.security.login"),
        ):
            result = view(request)
    ...
    def test_post_login_with_2fa_wrong_code(self, *_):
        ...
        with patch("reeltalk.views.preferences.security.LoginWith2FA"):
            result = view(request)
        self.assertEqual(result.status_code, 200)
        self.assertEqual(

...
from reeltalk import forms, models, views, settings
from reeltalk.views.books.edit_book import add_or_remove_authors
from reeltalk.tests.validate_html import validate_html
from reeltalk.tests.views.books.test_book import _setup_cover_url
...
class EditBookViews(TestCase):
    ...
    def test_add_authors_helper(self):
        ...
        with patch("reeltalk.utils.isni.find_authors_by_name") as mock:
            mock.return_value = []
    ...
    def test_existings_authors_aliases_add_author_helper(self):
        ...
        for author_name in [
            ...
            with patch("reeltalk.views.books.edit_book.find_authors_by_name") as mock:
                mock.return_value = []
                result = add_or_remove_authors(request, form.data)

...
class BookViews(TestCase):
    ...
    def test_book_page(self):
        ...
        with patch("reeltalk.views.books.books.is_api_request") as is_api:
    ...
    def test_update_book_from_remote(self):
        ...
        with patch(
            "reeltalk.connectors.openlibrary.Connector.update_book_from_remote"
        ) as mock:
    ...
    def test_resolve_book(self):
        ...
        with patch(
            "reeltalk.connectors.openlibrary.Connector.get_or_create_book"
        ) as mock:

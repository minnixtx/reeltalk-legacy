...
from reeltalk.settings import USER_AGENT
...
class OutboxView(TestCase):
    ...
    def test_outbox_reeltalk_request_true(self, _):
        """should differentiate between reeltalk and outside requests"""
        with patch("reeltalk.activitystreams.add_status_task.delay"):
            models.Review.objects.create(
                name="hi",
                content="look at this",
    ...
    def test_outbox_reeltalk_request_false(self, _):
        """should differentiate between reeltalk and outside requests"""
        with patch("reeltalk.activitystreams.add_status_task.delay"):
            models.Review.objects.create(
                name="hi",

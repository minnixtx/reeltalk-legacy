...
from reeltalk.importers import Importer
from reeltalk.models.import_job import start_import_task, import_item_task
from reeltalk.models.import_job import handle_imported_book
...
class GenericImporter(TestCase):
    ...
    def test_start_import(self, *_):
        ...
        with patch("reeltalk.models.import_job.start_import_task.delay") as mock:
    ...
    def test_start_import_task(self, *_):
        ...
        MockTask = namedtuple("Task", ("id"))
        with patch("reeltalk.models.import_job.import_item_task.delay") as mock:
            mock.return_value = MockTask(123)
    ...
    def test_import_item_task(self, *_):
        ...
        with patch(
            "reeltalk.models.import_job.ImportItem.get_book_from_identifier"
        ) as resolve:
    ...
    def test_handle_imported_book_shelf_override(self, *_):
        ...
        to_read.refresh_from_db()
        read.refresh_from_db()
        self.assertEqual(to_read.books.first(), self.book)
        self.assertIsNone(read.books.first())
    ...
    def test_handle_imported_book_review(self, *_):
        ...
        with (
            ...
            patch("reeltalk.models.Status.broadcast") as broadcast_mock,
        ):
            handle_imported_book(import_item)
        kwargs = broadcast_mock.call_args.kwargs
        self.assertEqual(kwargs["software"], "reeltalk")

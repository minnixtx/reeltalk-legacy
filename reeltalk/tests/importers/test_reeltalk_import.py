...
from reeltalk.importers import ReeltalkBooksImporter
...
class ReeltalkBooksImport(TestCase):
    """importing from ReelTalk csv"""

    def setUp(self):
        """use a test csv"""
        self.importer = ReeltalkBooksImporter()
        datafile = pathlib.Path(__file__).parent.joinpath("../data/reeltalk.csv")

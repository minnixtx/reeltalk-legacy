...
from reeltalk.connectors.reeltalk_connector import Connector as ReelTalkConnector
...
def fake_aredis(settings):
    ...
    with (
        mock.patch(
            "reeltalk.connectors.abstract_connector.redis",
            fakeredis.FakeAsyncRedis,
        ) as _fakeredis,
        mock.patch(
            "reeltalk.connectors.abstract_connector.REDIS_ACTIVITY_URL",
...
class ConnectorManager(TestCase):
    ...
    def test_get_or_create_connector(self):
        ...
        self.assertIsInstance(connector, ReelTalkConnector)
    ...
    def test_get_connectors(self):
        ...
        self.assertIsInstance(connectors[0], ReelTalkConnector)

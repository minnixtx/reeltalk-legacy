...
from reeltalk.connectors.openlibrary import Connector
from reeltalk.connectors.openlibrary import ignore_edition
from reeltalk.connectors.openlibrary import get_languages, get_description
from reeltalk.connectors.openlibrary import pick_default_edition, get_openlibrary_key
from reeltalk.connectors.openlibrary import parse_series, parse_series_number
from reeltalk.connectors.connector_manager import ConnectorException
...
class Openlibrary(TestCase):
    ...
    def test_get_edition_from_work_data(self):
        ...
        with patch(
            "reeltalk.connectors.openlibrary.pick_default_edition"
        ) as pick_edition:
    ...
    def test_expand_book_data(self):
        ...
        with patch(
            "reeltalk.connectors.abstract_connector.AbstractConnector."
    ...
    def test_create_edition_from_data(self):
        ...
        with patch(
            "reeltalk.connectors.openlibrary.Connector.get_authors_from_data"
        ) as mock:
            mock.return_value = []

...
from reeltalk.connectors.inventaire import Connector, get_language_code
...
class Inventaire(TestCase):
    ...
    def test_is_work_data(self):
        ...
        with patch("reeltalk.connectors.inventaire.get_data") as get_data_mock:
    ...
    def test_get_edition_from_work_data(self):
        ...
        with (
            patch(
                "reeltalk.connectors.inventaire.Connector.load_edition_data"
            ) as loader_mock,
            patch(
                "reeltalk.connectors.inventaire.Connector.get_book_data"
            ) as getter_mock,
        ):
    ...
    def test_get_work_from_edition_data(self):
        ...
        data = {"wdt:P629": ["hello"]}
        with patch("reeltalk.connectors.inventaire.Connector.get_book_data") as mock:

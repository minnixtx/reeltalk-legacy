...
from reeltalk.models.readthrough import ProgressMode
from reeltalk.readwise import (
...
class Readwise(TestCase):
    """sending ReelTalk quotes to Readwise"""
    ...
    def create_quotation(self):
        ...
        with (
            ...
            patch("reeltalk.activitystreams.add_status_task.apply_async"),
        ):
    ...
    def test_build_readwise_highlight(self):
        """format a ReelTalk quotation for Readwise"""
        ...
        self.assertEqual(result["source_type"], "reeltalk")

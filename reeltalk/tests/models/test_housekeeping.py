...
from reeltalk.models.housekeeping import delete_user_export_file_task
...
class TestCleanUpExportFiles(TestCase):
    ...
    def test_import_file_deleted(self, *_):
        ...
        import_job = ReeltalkImportJob.objects.create(
            user=self.user,
...
class Covers(TestCase):
    ...
    def test_get_cover_from_identifer(self):
        ...
        with open("test_image.jpg", "r+b") as f:
            ...
            with (
                patch(
                    "reeltalk.models.housekeeping.search",
                    return_value=self.query_response,
                ),
                patch(
                    "reeltalk.models.housekeeping.get_data", return_value=self.book_json
                ),
                patch(
                    "reeltalk.models.housekeeping.set_cover_from_url",
    ...
    def test_trigger_job_for_missing_covers(self):
        ...
        with patch("reeltalk.models.housekeeping.get_missing_cover_task.delay"):

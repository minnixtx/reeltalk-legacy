...
from reeltalk.models.activitypub_mixin import (
    ActivitypubMixin,
    ActivityMixin,
    broadcast_task,
    ObjectMixin,
...
class ActivitypubMixins(TestCase):
    ...
    def test_to_activity(self, *_):
        ...
        class TestModel(ActivitypubMixin, base_model.ReelTalkModel):
            """real simple mock model because ReelTalkModel is abstract"""
    ...
    def test_get_recipients_software(self, *_):
        """should differentiate between reeltalk and other remote users"""
        with patch("reeltalk.models.user.set_remote_server.delay"):
            another_remote_user = models.User.objects.create_user(
                "nutria",
                "nutria@nutria.com",
        ...
        recipients = ActivitypubMixin.get_recipients(mock_self, software="reeltalk")
        self.assertEqual(len(recipients), 1)
        self.assertEqual(recipients[0], self.remote_user.inbox)
    ...
    def test_object_save_create(self, *_):
        ...
        class ObjectModel(ObjectMixin, base_model.ReelTalkModel):
            """real simple mock model because ReelTalkModel is abstract"""
    ...
    def test_object_save_update(self, *_):
        ...
        class UpdateObjectModel(ObjectMixin, base_model.ReelTalkModel):
            """real simple mock model because ReelTalkModel is abstract"""
    ...
    def test_object_save_delete(self, *_):
        ...
        class DeletableObjectModel(ObjectMixin, base_model.ReelTalkModel):
            """real simple mock model because ReelTalkModel is abstract"""
    ...
    def test_broadcast_task(self, *_):
        ...
        with patch("reeltalk.models.activitypub_mixin.asyncio.run") as mock:

...
from reeltalk.models.import_job import construct_search_term
...
class ImportJob(TestCase):
    ...
    def test_get_book_from_identifier(self):
        ...
        with (
            patch("reeltalk.connectors.abstract_connector.load_more_data.delay"),
            patch(
                "reeltalk.connectors.connector_manager.first_search_result"
            ) as search,
        ):

...
class BaseModel(TestCase):
    ...
    def setUp(self):
        class ReelTalkTestModel(base_model.ReelTalkModel):
            """just making it not abstract"""

        self.test_model = ReelTalkTestModel()

    def test_remote_id(self):
        """these should be generated"""
        self.test_model.id = 1
        expected = self.test_model.get_remote_id()
        self.assertEqual(expected, f"{BASE_URL}/reeltalktestmodel/1")
    ...
    def test_remote_id_with_user(self):
        ...
        self.test_model.id = 1
        expected = self.test_model.get_remote_id()
        self.assertEqual(expected, f"{BASE_URL}/user/mouse/reeltalktestmodel/1")

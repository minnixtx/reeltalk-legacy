...
from reeltalk.settings import DOMAIN, BASE_URL
...
class User(TestCase):
    ...
    def test_user_shelves(self):
        ...
        self.assertTrue("Want to Watch" in names)
        self.assertTrue("Watched" in names)
    ...
    def test_activitypub_serialize(self):
        ...
        self.assertEqual(activity["reeltalkUser"], False)
    ...
    def test_delete_user(self, _):
        ...
        with (
            ...
            patch(
                "reeltalk.models.user.User.erase_user_statuses"

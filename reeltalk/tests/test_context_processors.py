...
from reeltalk.context_processors import site_settings
...
class ContextProcessor(TestCase):
    ...
    def test_theme_unset(self):
        ...
        self.assertEqual(settings["site_theme"], "css/themes/reeltalk-light.scss")
    ...
    def test_theme_instance_default(self):
        ...
        self.site.default_theme = models.Theme.objects.get(name="ReelTalk Dark")
        self.site.save()

        request = self.factory.get("")
        request.user = self.local_user
        settings = site_settings(request)
        self.assertEqual(settings["site_theme"], "css/themes/reeltalk-dark.scss")
    ...
    def test_theme_user_set(self):
        ...
        self.local_user.theme = models.Theme.objects.get(name="ReelTalk Dark")
    ...
    def test_theme_user_set_instance_default(self):
        ...
        self.local_user.theme = models.Theme.objects.get(name="ReelTalk Light")
        self.local_user.save(broadcast=False, update_fields=["theme"])

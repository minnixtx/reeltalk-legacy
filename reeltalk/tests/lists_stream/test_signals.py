...
from reeltalk import lists_stream, models
...
class ListsStreamSignals(TestCase):
    ...
    def test_add_list_on_create_command(self, _):
        ...
        with patch("reeltalk.lists_stream.add_list_task.delay") as mock:
    ...
    def test_remove_list_on_delete(self, _):
        ...
        with patch("reeltalk.lists_stream.remove_list_task.delay") as mock:
    ...
    def test_populate_lists_on_account_create_command(self, _):
        ...
        with patch("reeltalk.lists_stream.populate_lists_task.delay") as mock:
    ...
    def test_remove_lists_on_block(self, *_):
        ...
        with patch("reeltalk.lists_stream.remove_user_lists_task.delay") as mock:
    ...
    def test_add_lists_on_unblock(self, *_):
        ...
        with patch("reeltalk.lists_stream.remove_user_lists_task.delay"):
            block = models.UserBlocks.objects.create(
                user_subject=self.local_user,
                user_object=self.remote_user,
            )

        with patch("reeltalk.lists_stream.add_user_lists_task.delay") as mock:
            block.delete()

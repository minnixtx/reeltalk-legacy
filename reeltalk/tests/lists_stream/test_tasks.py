...
class Activitystreams(TestCase):
    ...
    def test_populate_lists_task(self, *_):
        ...
        with patch("reeltalk.lists_stream.ListsStream.populate_lists") as mock:
    ...
    def test_remove_list_task(self, *_):
        ...
        with patch(
            "reeltalk.lists_stream.ListsStream.remove_object_from_stores"
        ) as mock:
    ...
    def test_add_list_task(self, *_):
        ...
        with patch("reeltalk.lists_stream.ListsStream.add_list") as mock:
    ...
    def test_remove_user_lists_task(self, *_):
        ...
        with patch("reeltalk.lists_stream.ListsStream.remove_user_lists") as mock:
    ...
    def test_add_user_lists_task(self, *_):
        ...
        with patch("reeltalk.lists_stream.ListsStream.add_user_lists") as mock:

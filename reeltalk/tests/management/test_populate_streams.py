...
from reeltalk.management.commands.populate_streams import populate_streams
...
class Activitystreams(TestCase):
    ...
    def test_populate_streams(self, _):
        ...
        with (
            patch("reeltalk.activitystreams.populate_stream_task.delay") as redis_mock,
            patch("reeltalk.lists_stream.populate_lists_task.delay") as list_mock,
        ):
            populate_streams()
